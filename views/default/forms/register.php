...
<div class="rhs-steps">
    <?php if ($becon_enabled): ?>
        <div class="rhs-splash rhs-step js-validateForm" data-step="1">
    ...
    <div class="rhs-splash rhs-step js-validateForm" data-step="2" style="display:none;">
        <?php echo elgg_view("register/step-1-account", array(
            'step' => [2,3]
        )); ?>
    </div>

    <div class="rhs-splash rhs-step js-validateForm" data-step="3" style="display:none;">
