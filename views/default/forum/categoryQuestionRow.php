...
<div class="rhs-col-md-12">
  <div class="rhs-card-topic"><a href="<?php $question->getURL() ?>" title="Ga naar profielpagina" class="rhs-card-topic__profile-picture"><img src="<?php echo $profilePictureUrl ?>"></a>
    <div class="rhs-card-topic__content"><a href="<?php $question->getURL() ?>" title="..." class="rhs-card-topic__title"><?php echo $question->title ?></a>
    ...
    <div class="rhs-card-topic__aside">
      <div class="rhs-card-topic__views"><span>24</span></div><a href="#" title="Vraag volgen" class="rhs-card-topic__follow">Vraag volgen</a><a href="forum-item.html" title="Vraag antwoorden" class="rhs-card-topic__answers"><span><?php echo getNumAnswers($question) ?></span> antwoorden</a>
    </div>
  </div>
</div>