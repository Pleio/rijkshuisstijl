<div class="rhs-video-section">
  <div class="rhs-container">
      ...
      <div class="rhs-col-sm-12">
        <div data-video-block="" class="rhs-video-block">
          <div class="rhs-video-block__right">
            <div style="background-image:url('/mod/rijkshuisstijl/assets/image/dummy-video.jpg');" class="rhs-video-block__background"><a href="#" title="Speel video af" data-video-block-trigger="" data-video-type="youtube" data-video-id="dQw4w9WgXcQ" class="rhs-video-block__play"><span class="rhs-icon rhs-icon-play"></span></a></div>
              ...
              <div class="rhs-video-block__list">
                <div class="rhs-row">
                  <div class="rhs-col-md-6">
                    <div class="rhs-video-block__item"><a href="#" title="" data-video-type="youtube" data-video-id="kkwiQmGWK4c" class="rhs-video-block__link visited"><span>1.</span> Inleiding en programma</a></div>
    ...
    <div data-video-block="" class="rhs-video-block">
      <div class="rhs-video-block__right">
        <div style="background-image:url('/mod/rijkshuisstijl/assets/image/dummy-video.jpg');" class="rhs-video-block__background"><a href="#" title="Speel video af" data-video-block-trigger="" data-video-type="youtube" data-video-id="77-pNVbE0Uw" class="rhs-video-block__play"><span class="rhs-icon rhs-icon-play"></span></a></div>
        <div class="rhs-video-block__menu"><a href="#" title="Sluit overzicht" data-video-block-trigger="" class="rhs-video-block__menu-close"><span class="rhs-icon rhs-icon-cross"></span></a>
          <div class="rhs-video-block__title">Kwalificerende buitenlandse belastingplicht</div>
          <div class="rhs-video-block__list">
            <div class="rhs-row">
