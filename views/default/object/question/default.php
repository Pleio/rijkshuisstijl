...
<?php else: ?>
    <div class="rhs-col-md-12">
        <div class="rhs-card-topic">
            <a href="<?php echo $poster->getURL(); ?>" title="<?php echo elgg_echo("rijkshuisstijl:go_to_profile"); ?>" class="rhs-card-topic__profile-picture">
                <img src="<?php echo $poster->getIconURL('small') ?>">
            </a>
            <div class="rhs-card-topic__content">
                ...
                <div class="rhs-card-topic__info">
                        <span class="rhs-hidden-mobile">
                            <?php echo elgg_echo('rijkshuisstijl:cafe:askedby') ?>:
                        </span>
                        ...
                        <?php if ($latestAnswer): ?>
                            <br /><span class="rhs-hidden-mobile"><?php echo elgg_echo('rijkshuisstijl:cafe:latestanswer') ?>:</span>
